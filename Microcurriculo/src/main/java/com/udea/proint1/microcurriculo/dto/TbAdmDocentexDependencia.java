...
public class TbAdmDocentexDependencia implements java.io.Serializable {
	...
	public TbAdmDocentexDependencia() {
		super();
	}

	public TbAdmDocentexDependencia(TbAdmDependencia tbAdmDependencia,	TbAdmPersona tbAdmPersona) {
		this.tbAdmDependencia = tbAdmDependencia;
		this.tbAdmPersona = tbAdmPersona;
	}

	public TbAdmDocentexDependencia(TbAdmDependencia tbAdmDependencia,
